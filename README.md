...
- `sudo pacman -S uv firefox nautilus stow kitty waybar awww rofi rofimoji wtype swaync wlogout impala pavucontrol quickshell ttf-cascadia-code-nerd ttf-iosevka-nerd otf-geist-mono-nerd` 
